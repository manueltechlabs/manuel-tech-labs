---
title: 'Supply Chain Analytics Platform (TheLook eCommerce)'
slug: 'theLook-ecommerce-interactive-performance-dashboards'
permalink: 'theLook-ecommerce-interactive-performance-dashboards'
desc: 'End-to-end analytics system to measure and optimize supply chain performance, KPIs, SQL, Python, and Tableau dashboards.'
...
---
# Supply Chain Analytics Platform (TheLook eCommerce)

Built an end-to-end analytics system to measure and optimize supply chain performance, including KPIs for delivery reliability (OTIF), inventory turnover, and customer behavior.

Implemented SQL-based data exploration, Python-based analysis, and Tableau dashboards to identify inefficiencies in logistics, marketing conversion, and inventory management.
